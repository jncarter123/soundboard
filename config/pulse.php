...
return [
    ...
    */
    ...
    'recorders' => [
        ...
        // Custom recorder: the vendor ReverbConnections polls Pusher's default cloud
        // endpoint for our database-backed apps (empty Application options) and 404s.
        // Ours reuses ReverbApiService, which targets the local Reverb metrics API.
